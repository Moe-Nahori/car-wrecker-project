          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900">
                Get Top Cash For Your Car <span className="text-blue-600">Today</span>
              </h1>
          ...
          <div className="bg-white rounded-xl shadow-xl p-6">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">Enter your car details for an immediate valuation</p>
              </div>
              ...
              <div className="space-y-4">
                <input 
                  ...
                  className="w-full text-lg px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <button 
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white text-lg py-3 rounded-lg transition-colors"
                >
                  Get Free Quote Now
                </button>
              </div>
