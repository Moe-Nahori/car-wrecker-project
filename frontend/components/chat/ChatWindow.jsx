...
const ChatWindow = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed bottom-40 right-6 z-40 w-11/12 md:w-96 h-96 bg-white rounded-lg shadow-xl flex flex-col overflow-hidden border border-gray-200 md:bottom-20 md:right-8">
      {/* Chat header */}
